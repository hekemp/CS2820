 ...
 */
   Floor x=new Floor(7);
   int count=0;
   MockRobot m=new MockRobot(x);
   MockBelt b=new MockBelt();
   
  public Visualizer(){setup();}//default initializer
  
  public Visualizer(Floor x1,MockRobot m1){
      x=x1;
      m=m1;
      setup();
  }
 ...
 */
  public void tick(int n){
      ...
      public void run() {
         ...
         System.out.println("Robot now is at"+m.TrackRobot(n));
 ...
 */
    ...
    private void createAndShowGUI(int n) {
        
        JFrame f = new JFrame("Warehouse");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); 
       
        f.add(new MyPanel(this.x,this.m)); 
 ...
 */
    ...
    public MyPanel(Floor m1,MockRobot r2) {
